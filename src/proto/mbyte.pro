...
int dbcs_eat_space(int cc);
int utf_allow_break_after(int cc);
int utf_allow_break_before(int cc);
int utf_allow_break(int cc, int ncc);
int dbcs_allow_break_after(int cc);
int dbcs_allow_break_before(int cc);
int dbcs_allow_break(int cc, int ncc);
