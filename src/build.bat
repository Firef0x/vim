...
setlocal
REM nmake -f Make_mvc.mak GUI=yes MBYTE=yes IME=yes GIME=yes CSCOPE=yes DIRECTX=yes DEBUG=no PERL=C:\Perl DYNAMIC_PERL=yes PERL_VER=%LIBPERLVER% PYTHON=C:\Python27 DYNAMIC_PYTHON=yes PYTHON_VER=%LIBPYTHON2% PYTHON3=C:\Python35 DYNAMIC_PYTHON3=yes PYTHON3_VER=%LIBPYTHON3% RUBY=C:\Ruby22 DYNAMIC_RUBY=yes RUBY_VER=%LIBRBYSHRT% RUBY_VER_LONG=%LIBRBYLONG% RUBY_MSVCRT_NAME=msvcrt LUA="D:\codes\C++\fork\luajit\src" DYNAMIC_LUA=yes LUA_VER=%LIBLUAVER% CPU=AMD64 WINVER=0x0600 XPM="D:\codes\C++\fork\vim\src\xpm\x64" USERNAME=Firef0x USERDOMAIN=github.com %*
nmake -f Make_mvc.mak GUI=yes MBYTE=yes IME=yes GIME=yes CSCOPE=yes DIRECTX=yes DEBUG=no PERL=C:\Perl DYNAMIC_PERL=yes PERL_VER=%LIBPERLVER% PYTHON=C:\Python27 DYNAMIC_PYTHON=yes PYTHON_VER=%LIBPYTHON2% PYTHON3="C:\Program Files\Python36" DYNAMIC_PYTHON3=yes PYTHON3_VER=%LIBPYTHON3% LUA="D:\codes\C++\fork\luajit\src" DYNAMIC_LUA=yes LUA_VER=%LIBLUAVER% CPU=AMD64 WINVER=0x0600 XPM="D:\codes\C++\fork\vim\src\xpm\x64" USERNAME=Firef0x USERDOMAIN=github.com %*
endlocal
