...
set LIBTCLLONG=8.6
set LIBRBYSHRT=21
set LIBRBYLONG=2.1.0
set LIBLUAVER=51

setlocal
nmake -f Make_mvc.mak GUI=yes MBYTE=yes IME=yes GIME=yes CSCOPE=yes DIRECTX=yes DEBUG=no PERL=C:\Perl DYNAMIC_PERL=yes PERL_VER=%LIBPERLVER% PYTHON=C:\Python27 DYNAMIC_PYTHON=yes PYTHON_VER=%LIBPYTHON2% PYTHON3=C:\Python34 DYNAMIC_PYTHON3=yes PYTHON3_VER=%LIBPYTHON3% RUBY=C:\Ruby DYNAMIC_RUBY=yes RUBY_VER=%LIBRBYSHRT% RUBY_VER_LONG=%LIBRBYLONG% LUA="d:\codes\C++\fork\luajit\src" DYNAMIC_LUA=yes LUA_VER=%LIBLUAVER% CPUNR=i686 WINVER=0x0500 XPM="D:\codes\C++\fork\vim\src\xpm\x86" USERNAME=Firef0x USERDOMAIN=github.com %*
endlocal
